...
const CardSlider = () => {
  ...
  return (
    <div className="container mx-auto mt-32">
        <h1 className="text-center text-3xl font-bold mb-2 ">Deals Of The Day</h1>
        <p className="text-center">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Repudiandae?</p>
